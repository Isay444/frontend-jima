    ...
    const columns = useMemo(
        () => [
            ...
            },
            {
                ...
                header: 'Acciones',
                cell: ({ row }) => {
                    const id = row.original.idArea;
                    return (
                        <div className='flex items-center gap-2'>
                            {tienePermiso('AREA_UPDATE') && (
                                <button 
                                    onClick={() => navigate(`/catalogos/areas/editar/${id}`)}
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        ...
        onNuevo={tienePermiso('AREA_CREATE') ? () => navigate('/catalogos/areas/nuevo') : null}
        botonTexto="Área"
      />
      ...
      <ConfirmDialog
        open={!!deleteId}//open={Boolean(deleteId)}
